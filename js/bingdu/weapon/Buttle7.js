...
* name;
*/
var Buttle7 = /** @class */ (function (_super) {
    __extends(Buttle7, _super);
    function Buttle7() {
    ...
    Buttle7.prototype.sendBy = function (t, e, i, s, n, a, h) {
        this.x = this.startX = e,
            ...
            laya.utils.Tween.to(this.img, {
                scaleX: Weapon7.buttleScale,
                scaleY: Weapon7.buttleScale
            }, 600);
        //Weapon7.animBall.play(this.img);
    };
    Buttle7.prototype.testHit = function (t) {
        var e = 0, i = 0;
        e = t.x - this.x,
            i = t.y - this.y,
            this.hitX = e + this.x,
            ...
            e *= e,
            i = i * i + e,
            e = Weapon7.rButtle + t.r,
            e *= e;
        return (i < e);
    };
    Buttle7.prototype.hitFx = function () {
        MSound.ME.playSoundLimit("w_buttle7"),
            FPool.ME.createByFun(Buttle.createFxHit).play(this.hitX, this.hitY);
    };
    Buttle7.prototype.kill = function (e) {
        if (this.life--, this.life < 0 || null == e) {
            Weapon7.animBoom.play(this.x, this.y, Weapon7.buttleScale);
    ...
    Buttle7.prototype.kill2 = function () {
        this.life--;
        if (this.life < 0) {
    ...
    Buttle7.prototype.update = function () {
...
//# sourceMappingURL=Buttle7.js.map